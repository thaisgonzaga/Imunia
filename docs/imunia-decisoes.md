...
**O nome alterado acompanha o cadastro de tutor.** `users.name` e `tutores.nome` nascem iguais no autocadastro (P04), e é o segundo que encabeça a carteira e o histórico exportados. Deixá-los divergir faria a mesma pessoa aparecer com dois nomes conforme a tela, e o documento verificável exibiria o antigo para sempre.
